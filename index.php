...
<body>
 ...
 -->
	...
	<!-- Hero Section -->
	<section class="hero-section box-effect">
	...
	<!-- About Section -->
	<section class="spad container-fluid d-flex justify-content-between" >
		<div style="width: 20px; height: 800px; background-color: #b15df6;"></div>
		<div style="width: 95%; margin: auto;" class="box-effect" style="background-color: white;">
			<div class="section-title text-center">
				<img src="img/icons/logo-icon.png" alt="">
				<h2>Welcome to Yoga Classes</h2>
				<p>Yoga is a journey to finding that balance, both on and off the mat. A yoga practice stretches and
					strengthens our bodies; it teaches us to mindfully move and connect with our breath, which leads us
					to be mindful and present in our daily tasks. It teaches us the freedom to be still and connects
					us.!</p>
			</div>
			<div class="row">
				<div class="col-lg-6">
	...
	<!-- Classes Section -->
	<section class="classes-section spad box-effect">
		<div class="container">
			<div class="section-title text-center">
				<img src="img/icons/logo-icon.png" alt="">
				...
				if ($query->rowCount() > 0) {
					foreach ($results as $row) { ?>
						<div class="classes-item">
							...
							<div class="ci-text">
								<h4><a
										href="classes-details.php?viewid=<?php echo $row->ID; ?>"><?php echo $row->TypeofClasses; ?></a>
								</h4>
							...
							<div class="ci-bottom">
								...
								<a href="book-yoga-sesion.php?cid=<?php echo $row->ID; ?>" class="site-btn sb-gradient">book
									now</a>
							</div>
